 ...
 */
public class AssCommandGroundItemEnable extends PluginCommand<AdminSignShop>
{
	/**
	 * @param plugin The plugin that this object belong to.
	 */
	public AssCommandGroundItemEnable(AdminSignShop plugin)
	{
		super("enable", plugin);
		this.setAliases(Lists.newArrayList("on"));
		this.setDescription(plugin.messages.helpGroundItemEnable);
	...
	public boolean onCommand(CommandInfo commandInfo)
	{
		...
		if(creator!=null)
		{
			...
			message.add(plugin.messages.groundItemEnable);
